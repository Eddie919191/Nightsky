    ...
    try {
        ...
        if (detectBreakthrough) {
            ...
            const breakthroughPrompt = `
                Analyze the following conversation for a moment of personal insight, emotional breakthrough, or shift in perspective (e.g., realizing peace, strength, clarity, or letting go). Be highly sensitive to phrases like "let go," "feel strong," "breakthrough," or expressions of emotional release or renewal. If detected, provide a 2-3 sentence summary of the insight in a "breakthrough" object with a "summary" field, and suggest an emotion from: grief, love, wonder, hope, anger, trust. If none, return an empty object.
